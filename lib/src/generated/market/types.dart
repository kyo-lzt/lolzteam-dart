...
class UserModelCustomFields {
  ...
  factory UserModelCustomFields.fromJson(Map<String, dynamic> json) =>
      UserModelCustomFields(
        ...
        favoritePorn: json['favoritePorn'] is String
            ? json['favoritePorn'] as String
            : '',
        favoriteVape: json['favoriteVape'] is String
            ? json['favoriteVape'] as String
            : '',
        favoriteAnime: json['favoriteAnime'] is String
            ? json['favoriteAnime'] as String
            : '',
...
class UserModelTelegramClient {
  ...
  factory UserModelTelegramClient.fromJson(Map<String, dynamic> json) =>
      UserModelTelegramClient(
        telegramApiId: json['telegram_api_id'] is String
            ? json['telegram_api_id'] as String
            : '',
        telegramApiHash: json['telegram_api_hash'] is String
            ? json['telegram_api_hash'] as String
            : '',
        telegramDeviceModel: json['telegram_device_model'] is String
            ? json['telegram_device_model'] as String
            : '',
        telegramSystemVersion: json['telegram_system_version'] is String
            ? json['telegram_system_version'] as String
            : '',
        telegramAppVersion: json['telegram_app_version'] is String
            ? json['telegram_app_version'] as String
            : '',
        telegramSystemLangCode: json['telegram_system_lang_code'] is String
            ? json['telegram_system_lang_code'] as String
            : '',
        telegramLangCode: json['telegram_lang_code'] is String
            ? json['telegram_lang_code'] as String
            : '',
        telegramLangPack: json['telegram_lang_pack'] is String
            ? json['telegram_lang_pack'] as String
            : '',
      );
}
...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) => UserModel(
        ...
        customAccountDownloadFormat:
            json['custom_account_download_format'] is String
...
class ExtraModel {
  ...
  factory ExtraModel.fromJson(Map<String, dynamic> json) => ExtraModel(
        ...
        closeItem:
            json['close_item'] is bool ? json['close_item'] as bool : null,
        ...
        confirmationCode: json['confirmationCode'] is String
            ? json['confirmationCode'] as String
            : null,
        cookies: json['cookies'] is String ? json['cookies'] as String : null,
        loginWithoutCookies: json['login_without_cookies'] is bool
            ? json['login_without_cookies'] as bool
            : null,
        cookieLogin:
        ...
        theQuarry:
            json['the_quarry'] is bool ? json['the_quarry'] as bool : null,
        ...
        telegramClient: json['telegramClient'] is String
            ? json['telegramClient'] as String
            : null,
        telegramJson: json['telegramJson'] is String
            ? json['telegramJson'] as String
            : null,
        checkChannels: json['checkChannels'] is bool
            ? json['checkChannels'] as bool
            : null,
        checkSpam: json['checkSpam'] is bool ? json['checkSpam'] as bool : null,
        checkHypixelBan: json['checkHypixelBan'] is bool
            ? json['checkHypixelBan'] as bool
            : null,
      );
}
  ...
  factory ItemFromListModelBumpSettings.fromJson(Map<String, dynamic> json) =>
      ItemFromListModelBumpSettings(
        ...
        canBumpItemGlobally: json['canBumpItemGlobally'] is bool
            ...
            : null,
        shortErrorPhrase: json['shortErrorPhrase'] is String
            ? json['shortErrorPhrase'] as String
            : null,
        errorPhrase: json['errorPhrase'] is String
            ? json['errorPhrase'] as String
            : null,
      );
}
  ...
  factory ItemFromListModel.fromJson(Map<String, dynamic> json) =>
      ItemFromListModel(
        ...
        descriptionEn: json['description_en'] is String
            ...
            : null,
        itemDomain: json['item_domain'] is String
            ? json['item_domain'] as String
            : null,
        ...
        showGetEmailCodeButton: json['showGetEmailCodeButton'] is bool
            ...
            : null,
        canOpenItem:
            json['canOpenItem'] is bool ? json['canOpenItem'] as bool : null,
        canCloseItem:
            json['canCloseItem'] is bool ? json['canCloseItem'] as bool : null,
        canEditItem:
            json['canEditItem'] is bool ? json['canEditItem'] as bool : null,
        canDeleteItem: json['canDeleteItem'] is bool
            ? json['canDeleteItem'] as bool
            : null,
        canStickItem:
            json['canStickItem'] is bool ? json['canStickItem'] as bool : null,
        ...
        descriptionHtml: json['description_html'] is String
            ? json['description_html'] as String
            : null,
        descriptionHtmlEn: json['description_html_en'] is String
            ? json['description_html_en'] as String
            : null,
...
class BatchBatchResponseJobsJobId {
  ...
  factory BatchBatchResponseJobsJobId.fromJson(Map<String, dynamic> json) =>
      BatchBatchResponseJobsJobId(
        jobResult: json['_job_result'] is String
            ? json['_job_result'] as String
            : null,
        jobError:
            json['_job_error'] is String ? json['_job_error'] as String : null,
      );
}
  ...
  factory CategoryParamsResponseCategory.fromJson(Map<String, dynamic> json) =>
      CategoryParamsResponseCategory(
        ...
        categoryUrl: json['category_url'] is String
            ...
            : '',
        categoryDescriptionHtml: json['category_description_html'] is String
            ? json['category_description_html'] as String
            : '',
...
class ManagingGetResponse {
  ...
  factory ManagingGetResponse.fromJson(Map<String, dynamic> json) =>
      ManagingGetResponse(
        ...
        cannotBuyItemError: json['cannotBuyItemError'] is String
            ? json['cannotBuyItemError'] as String
            : '',
        canCloseItem:
        ...
        canDeleteItem: json['canDeleteItem'] is bool
            ? json['canDeleteItem'] as bool
            : false,
        canCancelConfirmedBuy: json['canCancelConfirmedBuy'] is bool
            ? json['canCancelConfirmedBuy'] as bool
            : false,
        canViewItemHistory: json['canViewItemHistory'] is bool
            ? json['canViewItemHistory'] as bool
            : false,
        faveCount:
            json['faveCount'] is bool ? json['faveCount'] as bool : false,
        isVisibleItem: json['isVisibleItem'] is bool
            ? json['isVisibleItem'] as bool
            : false,
        canViewLoginData: json['canViewLoginData'] is bool
            ? json['canViewLoginData'] as bool
            : false,
        showToFavouritesButton: json['showToFavouritesButton'] is bool
            ? json['showToFavouritesButton'] as bool
            : false,
        itemLink: json['itemLink'] is String ? json['itemLink'] as String : '',
        canChangeOwner: json['canChangeOwner'] is bool
...
class ManagingCreateClaimResponseThreadLinks {
  ...
  factory ManagingCreateClaimResponseThreadLinks.fromJson(
      ...
      ManagingCreateClaimResponseThreadLinks(
        ...
        lastPoster:
            json['last_poster'] is String ? json['last_poster'] as String : '',
        lastPost:
  ...
  factory ManagingCreateClaimResponseThread.fromJson(
      ...
      ManagingCreateClaimResponseThread(
        ...
        threadPrefixes: json['thread_prefixes'] is List
            ...
            : const [],
        threadTags: json['thread_tags'] is List
            ? json['thread_tags'] as List<dynamic>
            : const [],
        links: json['links'] is Map<String, dynamic>
...
class ManagingSteamGetMafileResponseMaFileSession {
  ...
  factory ManagingSteamGetMafileResponseMaFileSession.fromJson(
      ...
      ManagingSteamGetMafileResponseMaFileSession(
        ...
        steamLoginSecure: json['SteamLoginSecure'] is String
            ? json['SteamLoginSecure'] as String
            : '',
      );
}
...
class ManagingSteamGetMafileResponseMaFile {
  ...
  factory ManagingSteamGetMafileResponseMaFile.fromJson(
      ...
      ManagingSteamGetMafileResponseMaFile(
        sharedSecret: json['shared_secret'] is String
        ...
        accountName: json['account_name'] is String
            ? json['account_name'] as String
            : '',
        tokenGid:
            json['token_gid'] is String ? json['token_gid'] as String : '',
        identitySecret: json['identity_secret'] is String
            ? json['identity_secret'] as String
            : '',
        secret_1: json['secret_1'] is String ? json['secret_1'] as String : '',
        deviceId:
            json['device_id'] is String ? json['device_id'] as String : '',
        fullyEnrolled: json['fully_enrolled'] is bool
            ? json['fully_enrolled'] as bool
            : false,
...
class ManagingChangePasswordResponse {
  ...
  factory ManagingChangePasswordResponse.fromJson(Map<String, dynamic> json) =>
      ManagingChangePasswordResponse(
        status: json['status'] is String ? json['status'] as String : null,
        message: json['message'] is String ? json['message'] as String : null,
        newPassword: json['new_password'] is String
...
class PaymentsHistoryResponse {
  ...
  factory PaymentsHistoryResponse.fromJson(Map<String, dynamic> json) =>
      PaymentsHistoryResponse(
        ...
        periodLabel:
            json['periodLabel'] is String ? json['periodLabel'] as String : '',
        periodLabelPhrase: json['periodLabelPhrase'] is String
            ? json['periodLabelPhrase'] as String
            : '',
        filterDatesDefault: json['filterDatesDefault'] is bool
            ? json['filterDatesDefault'] as bool
            : false,
...
class PublishingCheckResponseItemEmailLoginData {
  ...
  factory PublishingCheckResponseItemEmailLoginData.fromJson(
      ...
      PublishingCheckResponseItemEmailLoginData(
        ...
        oldPassword:
            json['oldPassword'] is String ? json['oldPassword'] as String : '',
        encodedOldPassword: json['encodedOldPassword'] is String
            ? json['encodedOldPassword'] as String
            : '',
      );
}
  ...
  factory PublishingCheckResponseItem.fromJson(Map<String, dynamic> json) =>
      PublishingCheckResponseItem(
        ...
        showGetEmailCodeButton: json['showGetEmailCodeButton'] is bool
            ? json['showGetEmailCodeButton'] as bool
            : false,
        getEmailCodeDisplayLogin: json['getEmailCodeDisplayLogin'] is String
            ? json['getEmailCodeDisplayLogin'] as String
            : '',
        buyer: json['buyer'] is Map<String, dynamic>
        ...
        canAskDiscount: json['canAskDiscount'] is bool
            ...
            : false,
        tags: json['tags'],
        customFields: json['customFields'] is List
...
class PurchasingCheckResponse {
  ...
  factory PurchasingCheckResponse.fromJson(Map<String, dynamic> json) =>
      PurchasingCheckResponse(
        ...
        requireVideoRecording: json['requireVideoRecording'] is bool
            ? json['requireVideoRecording'] as bool
            : false,
        systemInfo: json['system_info'] is Map<String, dynamic>
            ? RespSystemInfo.fromJson(
                json['system_info'] as Map<String, dynamic>)
  ...
  factory PurchasingConfirmResponseItemLoginData.fromJson(
      ...
      PurchasingConfirmResponseItemLoginData(
        ...
        encodedOldPassword: json['encodedOldPassword'] is String
            ? json['encodedOldPassword'] as String
            : '',
        adviceToChangePassword: json['adviceToChangePassword'] is bool
            ? json['adviceToChangePassword'] as bool
            : false,
      );
}
