...
class CategoriesApi {
  ...
  Future<CategoriesGetResponse> get(num categoryId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
...
class ConversationsApi {
  ...
  Future<ConversationsGetResponse> get(num conversationId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ConversationsMessagesListResponse> messagesList(num conversationId, ConversationsMessagesListParams? params) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ConversationsMessagesCreateResponse> messagesCreate(num conversationId, ConversationsMessagesCreateBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
      path: '/conversations/$conversationId/messages',
      body: body?.toMap(),
  ...
  Future<ConversationsMessagesGetResponse> messagesGet(num messageId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ConversationsMessagesEditResponse> messagesEdit(num conversationId, num messageId, ConversationsMessagesEditBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'PUT',
  ...
  Future<ConversationsMessagesDeleteResponse> messagesDelete(num conversationId, num messageId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/conversations/$conversationId/messages/$messageId',
    ));
  ...
  Future<ConversationsInviteResponse> invite(num conversationId, ConversationsInviteBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ConversationsKickResponse> kick(num conversationId, ConversationsKickBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ConversationsReadResponse> read(num conversationId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ConversationsMessagesStickResponse> messagesStick(num conversationId, num messageId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ConversationsMessagesUnstickResponse> messagesUnstick(num conversationId, num messageId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/conversations/$conversationId/messages/$messageId/stick',
    ));
  ...
  Future<ConversationsStarResponse> star(num conversationId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ConversationsUnstarResponse> unstar(num conversationId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/conversations/$conversationId/star',
    ));
  ...
  Future<ConversationsAlertsEnableResponse> alertsEnable(num conversationId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ConversationsAlertsDisableResponse> alertsDisable(num conversationId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/conversations/$conversationId/alerts',
    ));
...
class ForumsApi {
  ...
  Future<ForumsGetResponse> get(num forumId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
      path: '/forums/$forumId',
    ));
  ...
  Future<ForumsFollowersResponse> followers(num forumId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ForumsFollowResponse> follow(num forumId, ForumsFollowBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
      path: '/forums/$forumId/followers',
      body: body?.toMap(),
  ...
  Future<ForumsUnfollowResponse> unfollow(num forumId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/forums/$forumId/followers',
    ));
...
class LinksApi {
  ...
  Future<LinksGetResponse> get(num linkId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
...
class NotificationsApi {
  ...
  Future<NotificationsGetResponse> get(num notificationId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
...
class PagesApi {
  ...
  Future<PagesGetResponse> get(num pageId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
      path: '/pages/$pageId',
    ));
...
class PostsApi {
  ...
  Future<PostsGetResponse> get(num postId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
      path: '/posts/$postId',
    ));
  ...
  Future<PostsEditResponse> edit(num postId, PostsEditBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'PUT',
      path: '/posts/$postId',
      body: body?.toMap(),
  ...
  Future<PostsDeleteResponse> delete(num postId, PostsDeleteBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/posts/$postId',
      body: body?.toMap(),
  ...
  Future<PostsLikesResponse> likes(num postId, PostsLikesParams? params) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<PostsLikeResponse> like(num postId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
      path: '/posts/$postId/likes',
    ));
  ...
  Future<PostsUnlikeResponse> unlike(num postId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/posts/$postId/likes',
    ));
  ...
  Future<PostsReportReasonsResponse> reportReasons(num postId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<PostsReportResponse> report(num postId, PostsReportBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
      path: '/posts/$postId/report',
      body: body?.toMap(),
...
class ProfilePostsApi {
  ...
  Future<ProfilePostsGetResponse> get(num profilePostId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ProfilePostsEditResponse> edit(num profilePostId, ProfilePostsEditBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'PUT',
      path: '/profile-posts/$profilePostId',
      body: body?.toMap(),
  ...
  Future<ProfilePostsDeleteResponse> delete(num profilePostId, ProfilePostsDeleteParams? params) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/profile-posts/$profilePostId',
      query: params?.toMap(),
  ...
  Future<ProfilePostsReportReasonsResponse> reportReasons(num profilePostId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ProfilePostsReportResponse> report(num profilePostId, ProfilePostsReportBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
      path: '/profile-posts/$profilePostId/report',
      body: body?.toMap(),
  ...
  Future<ProfilePostsStickResponse> stick(num profilePostId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ProfilePostsUnstickResponse> unstick(num profilePostId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/profile-posts/$profilePostId/stick',
    ));
  ...
  Future<ProfilePostsLikesResponse> likes(num profilePostId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ProfilePostsLikeResponse> like(num profilePostId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
      path: '/profile-posts/$profilePostId/likes',
    ));
  ...
  Future<ProfilePostsUnlikeResponse> unlike(num profilePostId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/profile-posts/$profilePostId/likes',
    ));
  ...
  Future<ProfilePostsCommentsGetResponse> commentsGet(num profilePostId, num commentId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ProfilePostsCommentsReportResponse> commentsReport(num commentId, ProfilePostsCommentsReportBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
...
class TagsApi {
  ...
  Future<TagsGetResponse> get(num tagId, TagsGetParams? params) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
      path: '/tags/$tagId',
      query: params?.toMap(),
...
class ThreadsApi {
  ...
  Future<ThreadsGetResponse> get(num threadId, ThreadsGetParams? params) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ThreadsEditResponse> edit(num threadId, ThreadsEditBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'PUT',
      path: '/threads/$threadId',
      body: body?.toMap(),
  ...
  Future<ThreadsDeleteResponse> delete(num threadId, ThreadsDeleteBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/threads/$threadId',
      body: body?.toMap(),
  ...
  Future<ThreadsMoveResponse> move(num threadId, ThreadsMoveBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ThreadsBumpResponse> bump(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ThreadsHideResponse> hide(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ThreadsStarResponse> star(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ThreadsUnstarResponse> unstar(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/threads/$threadId/star',
    ));
  ...
  Future<ThreadsFollowersResponse> followers(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ThreadsFollowResponse> follow(num threadId, ThreadsFollowBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
      path: '/threads/$threadId/followers',
      body: body?.toMap(),
  ...
  Future<ThreadsUnfollowResponse> unfollow(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'DELETE',
      path: '/threads/$threadId/followers',
    ));
  ...
  Future<ThreadsNavigationResponse> navigation(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ThreadsPollGetResponse> pollGet(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'GET',
  ...
  Future<ThreadsPollVoteResponse> pollVote(num threadId, ThreadsPollVoteBody? body) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
  ...
  Future<ThreadsFinishResponse> finish(num threadId) async {
    final raw = await _http.request(RequestOptions(
      method: 'POST',
